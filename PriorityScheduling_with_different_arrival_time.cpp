// C++ implementation for Priority Scheduling with Different Arrival Time priority scheduling 
#include <bits/stdc++.h> 
using namespace std;
...
int bursttime[] = { 2, 5, 3, 7, 4 };
int priority[] = { 2, 4, 1, 7, 9 };
    ...
    //Calling function findgc for finding Gantt Char 
    findgc(); 
